...
const polygonGeoJSONUrl = 'jscroot/template/content/geojson/ch2/Cimahi.json';
const lineStringGeoJSONUrl = 'jscroot/template/content/geojson/ch2/Cimahi.json';
const pointGeoJSONUrl = 'jscroot/template/content/geojson/ch2/Cimahi.json';
